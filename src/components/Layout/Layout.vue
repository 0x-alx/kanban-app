...
<template>
    <div class="flex flex-col h-full w-full overflow-x-hidden">
        ...
        <button
            ...
            class="absolute flex items-center justify-center w-16 bottom-8 -left-2 bg-primary p-4 rounded-r-full cursor-pointer hover:translate-x-2 transition-transform"
